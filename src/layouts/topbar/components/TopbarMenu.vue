...
.menu :deep(.ant-menu-item a),
.menu :deep(.ant-menu-submenu-title a) {
  color: inherit;
  text-decoration: none;
}

.menu :deep(.ant-menu-item a:hover),
.menu :deep(.ant-menu-submenu-title a:hover) {
  color: inherit;
}
...
.menu :deep(.ant-menu-submenu-selected) {
...
@media (max-width: 768px) {
  ...
  .menu :deep(.ant-menu-submenu .anticon) {
    margin-right: 0;
  }
  
  .menu :deep(.ant-menu-item span),
  .menu :deep(.ant-menu-submenu-title span) {
    display: none;
  }
}
</style>